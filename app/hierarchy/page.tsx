...
//     role: "subordinate", // Default role as subordinate
//     parentId: "",
//   });
...
//       const parentId = user._id; // Extract the logged-in user's ID as parentId
...
//         role: "subordinate", // Hardcoding role as 'subordinate'
//         parentId: parentId, // Use the logged-in user's ID as parentId
//       };
...
//             Authorization: `${token}`, // Token passed in headers
//           },
...
//       // Optionally refetch hierarchy data to reflect the new subordinate
...
//                 <DialogDescription>
//                   Create a new subordinate in your organization hierarchy.
//                 </DialogDescription>
//               </DialogHeader>
...
//   function handleEditSubordinate() {
...
//   function openEditDialog(subordinate: Subordinate) {
//     setSelectedSubordinate(subordinate);
//     setFormData({
//       username: subordinate.username,
//       email: "", // Populate if available in API
//       phone: "", // Populate if available in API
//       password: "",
  ...
  const handleAddSubordinate = async () => {
    try {
      ...
      const payload = {
        ...
        password: subordinateFormData.password,
        role: "subordinate",
        parentId: subordinateFormData.parentId, // Use the clicked subordinate's _id
      };
  ...
  const handleAddProperty = async () => {
    try {
      ...
      const payload = {
        address: propertyFormData.address,
        currentRent: Number(propertyFormData.currentRent),
        currentManager: propertyFormData.currentManager, // Use the clicked subordinate's _id
      };
              ...
              <div className="grid gap-6 py-4">
                ...
                <div>
                  ...
                  <div className="grid gap-4">
                    ...
                    <Button onClick={handleAddSubordinateTwo}>
                      Add Subordinate
                    </Button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid gap-4">
                    ...
                    <Button onClick={handleAddPropertyTwo}>Add Property</Button>
                  </div>
                </div>
              </div>
              <DialogFooter>
